...
#### 47.请写出至少五中css浏览器的兼容性写法

#### 48.jquery的绑定事件有几种方式，请举例说明其优缺点。
#### 49.请写出至少三种js浏览器兼容性的写法。
#### 50.请写出js内存泄漏的问题
#### 51.谈谈你对js闭包的理解
#### 52.写出js面向对象的几种方式
#### 53.写出几种IE6 BUG的解决方法。
...
#### 23.请用div+css写出文字水平垂直居中，图片水平垂直居中样式级布局

#### 24.请用div+css写出左侧固定(width:200px),右侧自适应的页面布局
